...
/**
* Controls the rule creation screen functionalities.
* Manages rule addition, triggers, actions, and navigation between screens.
* @author group08
*/
public class RuleCreateScreenController implements Initializable {
    ...
    private void saveRuleAction(ActionEvent event)  {
        ...
        if (ruleManager.getCurrentRule().getTrigger() == null) {
            ...
            cs.switchScreen("/softeng_project_group08/view/MainScreen.fxml", currentStage);
    ...
    private void addTriggerAction(ActionEvent event)  {
        ...
        Initializable newController = cs.switchScreen("/softeng_project_group08/view/TriggerCreateScreen.fxml", currentStage);
    ...
    private void addAction(ActionEvent event) {
        ...
        Initializable newController = cs.switchScreen("/softeng_project_group08/view/ActionCreateScreen.fxml", currentStage);
    }
    ...
    private void backAction(ActionEvent event)  {
        ...
        Initializable newController = cs.switchScreen("/softeng_project_group08/view/MainScreen.fxml", currentStage);
