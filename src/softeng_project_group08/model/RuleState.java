...
/**
 * A rule can be in one of four states: - active and not recurring - active and
 * recurring - inactive and not recurring - inactive and recurring The client
 * can manipulate the Rule state only by using public methods of the Rule class
 *
 * @author group08
 */
